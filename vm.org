...
** v004 Instruction Set Reconfiguring [1/4]
- [X] C PR : Replace COLOR mode and MOVE command with RSHFT and LSHFT
- [ ] C PR : Replace PEEK w/ argument with PEEK : copy second item on stack to top of stack
