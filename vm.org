...
** v003 Basic demos and assembly analysis [8/22]
...
(regexp-opt '("DROP" "DUP" "SWAP" "CONST3_0" "CONST4_0" "CONST3_1" "CONST4_1" "AND" "OR" "NOT" "TRUE" "ZERO2" "EQUAL3" "ADD21" "ADD22" "ADDC3_1" "ADDC4_1" "SUB21" "SUB22" "SUB31" "SUB33" "MULT" "MULT21" "MULT22" "DIV" "DIV21" "DIV22" "DIV31" "MOD" "MOD21" "MOD22" "OUT" "OUT8" "OUT12" "OUT16"))
...
*** MATH : ADDITION
ADD21          : (-1) (0)  : Adds a one-digit number to a two-digit number
ADD22          : (-2) (0)  : Adds a two-digit number to a two-digit number
