...
** v003 Basic demos and assembly analysis [4/16]
- [X] F AS : ADDC3_1 expansion
- [X] F AS : ADDC4_1 expansion
- [ ] F AS : EQUAL3 expansion
- [ ] F AS : SUB33 expansion
...
- [ ] R AS : Seperate dictionary definition literals from hashtable builder and return functions
- [ ] F VM : Export heatmap file of bytecode program (as a compile option)
...
- [ ] F AS : Export mapping file of hxb bytes to hxa original. May get wacky when linking eventually 
- [ ] B AS : Properly handle trailing whitespace at end of lines
- [ ] R AS : more clearly differentiate symbols for local and globabl references and labels @ > % etc
- [ ] F AS : Report when trying to reference a non-existent label
...
(regexp-opt '("DROP" "DUP" "SWAP" "AND" "OR" "NOT" "TRUE" "ZERO2" "EQUAL3" "ADD21" "ADD22" "ADDC3_1" "ADDC4_1" "SUB21" "SUB22" "SUB33" "MULT" "MULT21" "MULT22" "DIV" "DIV21" "DIV22" "MOD" "MOD21" "MOD22" "OUT" "OUT8" "OUT12" "OUT16"))
...
ZERO2          : (-1) ()   : Returns a one-digit zero if the two-digit number is zero

*** MATH : COMPARISON

EQUAL3         : (-5) (0)  : Compares the top two 3-digit numbers. Returns F if equal, 0 otherwise

*** MATH : ADDITION
ADD21          : (-1) ()   : Adds a one-digit number to a two-digit number
ADD22          : (-2) ()   : Adds a two-digit number to a two-digit number
...
SUB22          : (-2) (0)  : Subtracts a two-digit number from a two-digit number
...
DIV22          : (-2) (0)  : Divides a two-digit number by a two-digit number. Sets FLAG if /0

*** MATH : MODULO
MOD            : (-1) (0)  : Takes the modulo of a one-digit number and a one-digit number
MOD21          : (-1) (0)  : Takes the modulo of a two-digit number and a one-digit number
MOD22          : (-2) (0)  : Takes the modulo of a two-digit number and a two-digit number
