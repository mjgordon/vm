...
* Current
- Adding datatype virality during generation, currently at the term level
- Need to ensure there are assembler macros for all needed permutations, and well as swap macros, to cut down on the number of total macros e.g. ADD21 vs ADD12
