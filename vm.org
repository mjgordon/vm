...
** v002 Additions to assembler and dictionary [22/34]
...
- [ ] F VM : Add stack analysis in fast way
...
- [ ] C VM : Read program file name as argument
- [ ] F VM : Adaptive output mode
...
- [ ] R PR : hxa/hxb files should live in their own top level project directory. Others should write/read from there
...
- [ ] B VM : Compiler warnings in vm.c
