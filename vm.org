...
** v003 Basic demos and assembly analysis [20/34]
...
- [ ] F PR : Input program filename to test script, VC script
...
- [ ] B VM : Program timing rolls over :P
- [ ] B VM : Window Display isn't persistent
