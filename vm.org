...
** v005 Compiling and Linking [16/20]
...
- [ ] F CM : Automatic compiler testing against valid and invalid single-file programs
...
- [ ] C AS : Rename opcodes and macros reflect bit-lengths rather than word-lengths
...
(regexp-opt '("DROP" "DROP1" "DUP" "SWAP" "CONST3_0" "CONST4_0" "CONST3_1" "CONST4_1" "AND" "OR" "NOT" "TRUE" "BIN" "ZERO2" "EQUAL3" "ADD21" "ADD22" "ADD31" "ADDC3_1" "ADDC4_1" "SUB21" "SUB22" "SUB31" "SUB33" "MULT" "MULT21" "MULT22" "DIV" "DIV21" "DIV22" "DIV31" "MOD" "MOD21" "MOD22" "MOD31" "NEG" "OUT" "OUT8" "OUT12" "OUT16" "PEEK2" "PEEK3"))
