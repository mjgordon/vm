...
** v005 Compiling and Linking [6/11]
...
- [ ] F CM : Automatically split literal-ints into multiple nb
- [ ] F AS : Automatically split literal-ints into multiple nb
...
- [ ] C PR : Decide on 2,3,4 vs 8,12,16 naming convention for multi-nb numbers
