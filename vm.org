...
** v002 Additions to assembler and dictionary [34/35]
...
(regexp-opt '("DROP" "DUP" "SWAP" "AND" "OR" "NOT" "TRUE" "ZERO2" "ADD21" "ADD22" "SUB21" "SUB22" "MULT" "MULT21" "MULT22" "DIV" "DIV21" "DIV22" "MOD" "MOD21" "MOD22" "OUT" "OUT8" "OUT12" "OUT16"))
...
# Returns a one digit zero if the two digit number is zero
_ZERO2                          (A B) ()
ADD POP                         (A+B) ()
ADD PUSH POP                    (A+B+F) ()
_RESULT                         (-1) (0)
